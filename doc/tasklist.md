...
| 1 | Базовая структура + Hero секция | ⏳ В процессе | - |
| 2 | Секция "О проекте" | ⬜ Не начато | - |
...
**Задачи:**
- [ ] Создать `app/layout.tsx` с базовыми мета-тегами (английский язык)
- [ ] Настроить глобальные стили в `app/globals.css`
- [ ] Создать компонент `Hero.tsx` с названием MEOW BORG
- [ ] Добавить слоган/описание системы (на английском)
- [ ] Применить цветовую схему (желтый, красный, черный, белый)
- [ ] Добавить базовую типографику
